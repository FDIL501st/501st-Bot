...
class Legacy_Random_Facts(commands.Cog):
    def __init__(self, *args, **kwargs):
        ...
        "Killer whales attack blue whales in groups. Studies suggest that killer whales are more likely to harass the blue whale for fun and not just merely for hunting.",
        "The blue whale has an unbelievable sense of hearing. . Under the right circumstances, each of them can interact and hear each other as far as 1,600-kilometres away.",
        ...
        "Whales share the same names as cows. If the newborn whales are called 'Calves', the female whales are called 'Cows', while the male whales are called 'Bulls.'",
        "Blue whales love to sing. Except for humans, whales are the only mammals on earth who can sing.",
        "Blue Whales aren't a true blue in color.",
        "Dolphins are whales, but whales aren't dolphins. Whales have two blowholes, unlike dolphins who only have one.",
