"""
Copied file from gpt4all repo. 
Need this file for some parts when I'm trying to override the GPT4All functions.
Also commented out some things that messed up gpt4all import in other files.
"""
...
def find_cuda() -> None:
    ...
    if platform.system() in ("Linux", "Windows"):
        try:
            from nvidia import cuda_runtime, cublas # type: ignore
        except ImportError:
